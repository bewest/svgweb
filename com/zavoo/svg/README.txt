...
svgviewer.swf is a flash "movie" used to support SVG (scalable vector graphics) files.

Only partial support is implemented at this time. See the example html files in
this directory.

You can specify the URL of an SVG image to load via an HTML parameter, or via the
javascript interface.

Alternatively, you can use javascript to directly pass it the SVG xml content as
